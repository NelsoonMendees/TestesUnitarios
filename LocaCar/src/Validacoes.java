...
public class Validacoes {
    ...
    public static boolean isFoneValid(String telefone) {
        ...
        // Se o número só tiver dez digitos não é um celular e por isso o número logo
        // após o DDD deve ser 2, 3, 4, 5 ou 7
